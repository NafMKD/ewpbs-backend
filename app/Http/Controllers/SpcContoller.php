...
class SpcContoller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return SpcInformation::create($request->all());
    }
    ...
    {
        return new SpcResource(SpcInformation::find($id));
    }
    ...
    {
        $request->validate([
            'spc_name' => 'required|max:150'
        ]);
        return SpcInformation::find($id)->update($request->all());
    }
